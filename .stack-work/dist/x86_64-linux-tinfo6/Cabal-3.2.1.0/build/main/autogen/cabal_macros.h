...
/* package haskellsocool-0.0.0 */
#ifndef VERSION_haskellsocool
#define VERSION_haskellsocool "0.0.0"
#endif /* VERSION_haskellsocool */
#ifndef MIN_VERSION_haskellsocool
#define MIN_VERSION_haskellsocool(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_haskellsocool */
...
#define CURRENT_COMPONENT_ID "haskellsocool-0.0.0-BMsLrAeL3AQ1AUj9jatpXH-main"
